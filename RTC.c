...
void RTC_Init(void) {
	...
	RTC_Set_Calendar_Date(RTC_WEEKDAY_TUESDAY, 0x15, 0x03, 0x22); 
	
	// Configure the Time 
	RTC_Set_Time(0x0, 0x23, 0x52, 0x00);
...
void RTC_Set_Calendar_Date(uint32_t WeekDay, uint32_t Day, uint32_t Month, uint32_t Year)	{
	//set calendar date
	RTC->DR &= ~(RTC_DR_WDU|RTC_DR_DT|RTC_DR_DU|RTC_DR_MT|RTC_DR_MU|RTC_DR_YT|RTC_DR_YU);
	RTC->DR |= 0x00000000|(Year << 16)|(WeekDay << 13)|(Month << 8)|Day; 
}

void RTC_Set_Time(uint32_t Format12_24, uint32_t Hour, uint32_t Minute, uint32_t Second) {
	//set time
	RTC->TR &= ~(RTC_TR_HT|RTC_TR_HU|RTC_TR_MNT|RTC_TR_MNU|RTC_TR_ST|RTC_TR_SU);
	RTC->TR |= 0x00000000|(Format12_24 << 22)|(Hour << 16)|(Minute << 8)|Second;
}
